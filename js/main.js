...
/**
 * Vérifie le formulaire proposition d'une oeuvre  
 * @access public
 * @author Gautier Piatek
 */
function validerFormPropositionOeuvre(){
    ...
    $collectifArtiste = $('#collectifArtiste');
    $image = $('#image');
    ...
    if(valide_valide == false)
    {
       ...
       if(!$titre.val().match(/^[a-zA-ZÀ-ÿ\s\'\:\;\.\,\/\(\)\"-]{4,128}$/)){ 
        ...
        if($prenomArtiste.val() != '') {
            if(!$prenomArtiste.val().match(/^[a-zA-ZÀ-ÿ\s\'\:\;\.\,\/\(\)\"-]{4,128}$/)){
            $("#msjPrenomArtiste").css("display", "block");
            valide=false;
            }
        }else
        {
            $("#msjPrenomArtiste").css("display", "none");
        }
        
        if($nomArtiste.val() != '') {
            if(!$nomArtiste.val().match(/^[a-zA-ZÀ-ÿ\s\'\:\;\.\,\/\(\)\"-]{4,128}$/)){
            $("#msjNomArtiste").css("display", "block");
            valide=false;
            }
        }else
        {
            $("#msjNomArtiste").css("display", "none");
        }
        
         if($collectifArtiste.val() != '') {
            if(!$collectifArtiste.val().match(/^[a-zA-ZÀ-ÿ\s\'\:\;\.\,\/\(\)\"-]{4,128}$/)){
            $("#msjCollectifArtiste").css("display", "block");
            valide=false;
            }
        }else
        {
            $("#msjCollectifArtiste").css("display", "none");
        }
        ...
        if($image.val() == '') {
            ...
            $("#msjImage").css("display", "block");
            valide=false;
            
        }else
        {
            $("#msjImage").css("display", "none");
        }
    ...
    if(valide==true && valide_valide==false){    
      ...
      document.formPropositionOeuvre.submit();
